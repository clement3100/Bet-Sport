    ...
    <div style={{ minHeight: "100vh", background: BG }}>
      <div style={{ padding: "40px 28px 36px", background: `linear-gradient(180deg, #0e0c08 0%, ${BG} 100%)`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "32px" }}>
          ...
          <div>
            <div style={{ fontFamily: "'Georgia', serif", fontWeight: "900", fontSize: "22px", background: `linear-gradient(135deg, ${GOLD_LIGHT}, ${GOLD_DARK})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>BetSport</div>
      ...
      <div style={{ padding: "24px 20px" }}>
        ...
        <div style={{ background: "#0b0b0f", border: "1px solid #13131a", borderRadius: "16px", padding: "20px" }}>
          ...
          <div style={{ color: "#fff", fontSize: "14px", fontWeight: "700", marginBottom: "10px" }}>
            Bienvenue sur <span style={{ background: `linear-gradient(135deg, ${GOLD_LIGHT}, ${GOLD_DARK})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>BetSport</span>
          </div>
          <p style={{ color: "#666", fontSize: "13px", lineHeight: "1.75", margin: 0 }}>
            Une équipe de pronostiqueurs professionnels partage ses meilleurs pronostics <span style={{ color: GOLD }}>chaque jour</span>. Consultez nos conseils et suivez nos performances en temps réel.
          </p>
        </div>
      </div>
    </div>
      ...
      {view !== "home" && (
        <div style={{ padding: "24px 24px 16px", borderBottom: "1px solid #0e0e12", background: BG, position: "sticky", top: 0, zIndex: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <div style={{ fontFamily: "'Georgia', serif", fontWeight: "900", fontSize: "20px", background: `linear-gradient(135deg, ${GOLD_LIGHT}, ${GOLD_DARK})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>BetSport</div>
            ...
            <div style={{ marginBottom: "20px" }}>
              {!footballLevel && (
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  {[
                    { id: "nationale", label: "Nationale", icon: "🔷", sub: "9 championnats", color: GOLD },
              ...
              {footballLevel && !activeLeague && (
                <div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "14px" }}>
                    <span style={{ fontSize: "20px" }}>{footballLevel === "nationale" ? "🔷" : "🌐"}</span>
          ...
          {form.sport === "football" && (
            <div style={{ marginBottom: "16px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                <span>🔷</span><span style={{ color: "#444", fontSize: "10px", fontFamily: "monospace" }}>NATIONALE</span>
